...
//	}
	...
	public void run() {
		...
		if(serverMess.hasInfo()){
			...
			theView.deathNewsArrived(serverMess.getDeath().getKiller(), serverMess.getDeath().getVictim());
			...
			theView.projectilesSpawned(location, dir, serverMess.getProj().getOwner());
